...
| --- | --- | --- | ---  |
|5.x|4.12.x and above|4.12.x and above|21 |
|4.x|4.9.x to 4.11.x|-|21 |
|3.x|4.6.x to 4.8.x|-|17 |
|2.x|4.5.x and below|4.0.x to 4.11.x|17 |
...
* remove default value for deprecated scope field in Groovy policy schema ([2fb67a5](https://github.com/gravitee-io/gravitee-policy-groovy/commit/2fb67a5283715dc6ffcd3f2101d60f797b528659))
...
* Revert "fix(groovy): limit script execution time and always run scripts off the event loop" ([50ae720](https://github.com/gravitee-io/gravitee-policy-groovy/commit/50ae720699cdb026c865f3fea4753712f351ce72))

#### [5.0.2](https://github.com/gravitee-io/gravitee-policy-groovy/compare/5.0.1...5.0.2) (2026-07-07)


##### Bug Fixes

* declare default schema explicitly in plugin manifest ([3b62772](https://github.com/gravitee-io/gravitee-policy-groovy/commit/3b62772e2972556a3537c2ce84b3b3ca27722b94))
...
* **groovy:** limit script execution time and always run scripts off the event loop ([ad10d44](https://github.com/gravitee-io/gravitee-policy-groovy/commit/ad10d440813034c250912ff8186d884e045724fe))
