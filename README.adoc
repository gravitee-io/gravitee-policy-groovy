...
image:https://badges.gitter.im/gravitee-io/gravitee-policy-groovy.svg[link="https://gitter.im/gravitee-io/gravitee-policy-groovy?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge"]
