...
image:https://badges.gitter.im/Join Chat.svg["Gitter", "https://gitter.im/gravitee-io/gravitee-groovy-policy?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge"]
